  ...
  return (
    <html lang="en" className={`${GeistSans.variable} ${GeistMono.variable}`} suppressHydrationWarning>
      ...
      <body className="font-geist-sans bg-white overscroll-none dark:bg-zinc-900">
        <ThemeProvider defaultTheme="dark" storageKey="amogh-theme">
          {children}
        </ThemeProvider>
      </body>
...
export const metadata: Metadata = {
  ...
  title: {
    default: "Amogh Kini | Software Engineer | Based in Mumbai",
    template: `%s - Amogh Kini | Software Engineer | Based in Mumbai`,
  },
